...
export interface PersonRating { id: string; personId?: string; personName: string; targetType: "course" | "wine_experience" | "pairing"; targetId: string; rating: 1 | 2 | 3 | 4 | 5; note: string; createdAt?: string; }
export interface DinnerNote { id: string; dinnerId: string; authorName: string; body: string; createdAt: string; }
export interface DinnerPhoto { id: string; dinnerId: string; courseId?: string; url: string; caption: string; createdAt: string; storagePath?: string; }
